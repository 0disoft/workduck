export const esProjectsMessages = {
		...
		ssealedScaffold: {
			title: 'Aplicar ssealed',
			scaffoldLabel: 'Scaffold',
			createScaffoldLabel: 'Scaffold ssealed',
			profileLabel: 'Perfil del repositorio',
			none: 'Ninguno',
			createWithoutFiles: 'Crear la carpeta sin añadir archivos de ssealed.',
			filePreviewLabel: 'Vista previa de archivos ssealed',
			...
			optionLabels: {
				...
				sdk: 'SDK',
				'worker-service': 'Servicio worker',
				'infra-module': 'Módulo de infraestructura',
			...
			scopeDescriptions: {
				backend: 'Docs de APIs de servidor, bases de datos, jobs y propiedad backend.',
				frontend: 'Docs de UI del navegador, rutas, componentes y comportamiento cliente.',
				fullstack: 'Límites frontend y backend para un repositorio de aplicación.',
				general: 'Docs de producto y arquitectura cuando la stack aún no está decidida.',
				mobile: 'Docs de propiedad, release, dispositivo y runtime para app móvil.',
				infra: 'Docs de infraestructura, despliegue, operaciones y runbooks.',
				data: 'Docs de pipeline de datos, linaje, calidad y contratos analíticos.'
			},
			profileDescriptions: {
				generic: 'Valores neutrales para un repositorio ordinario.',
				'cli-tool': 'Herramientas de línea de comandos con docs de comandos, opciones y releases.',
				'api-service': 'Servicios HTTP o RPC con contratos API y docs operativas.',
				'desktop-app': 'Apps de escritorio con docs de empaquetado, actualización y runtime.',
				library: 'Paquetes reutilizables con API pública y docs de compatibilidad.',
				'web-app': 'Aplicaciones web con docs de rutas, renderizado y despliegue.',
				'mobile-app': 'Apps móviles con docs de plataforma, tienda y dispositivo.',
				sdk: 'SDKs para desarrolladores con API cliente y versionado.',
				'worker-service': 'Workers, colas, schedulers y docs de reintentos.',
				'infra-module': 'Módulos de infraestructura con docs de plan, apply y rollback.',
				'data-pipeline': 'Ingesta, transformación, linaje y calidad de datos.',
				'github-action': 'GitHub Actions con inputs, permisos y docs de release.',
				'browser-extension': 'Extensiones de navegador con permisos y release de tienda.',
				plugin: 'Integraciones tipo plugin con contratos de host y ciclo de vida.',
				'docs-site': 'Sitios de documentación con navegación y publicación.',
				monorepo: 'Repositorios multipaquete con workspace y propiedad.'
			}
		},
		errors: {
