export const hiEnvironmentMessages = {
	...
	applyCliEnvironmentTooltip:
		'गुप्त मानों को उपयोगकर्ता पर्यावरण चर में सादे पाठ के रूप में सहेजता है। इसी उपयोगकर्ता के अन्य प्रोसेस इन्हें पढ़ सकते हैं।',
	cliEnvironmentConfirm:
		'क्या इन गुप्त मानों को उपयोगकर्ता पर्यावरण चर में सादे पाठ के रूप में सहेजना है? इसी उपयोगकर्ता के अन्य प्रोसेस इन्हें पढ़ सकते हैं।',
	secretKinds: {
		'api-key': 'एपीआई कुंजी',
		token: 'टोकन',
