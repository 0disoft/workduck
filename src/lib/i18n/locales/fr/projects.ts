export const frProjectsMessages = {
	...
	ssealedScaffold: {
		title: 'Appliquer ssealed',
		scaffoldLabel: 'Scaffold',
		createScaffoldLabel: 'Scaffold ssealed',
		profileLabel: 'Profil du dépôt',
		none: 'Aucun',
		createWithoutFiles: 'Créer le dossier sans ajouter de fichiers ssealed.',
		filePreviewLabel: 'Aperçu des fichiers ssealed',
		checkingFiles: 'Vérification des fichiers.',
		noPreview: 'Aucun aperçu pour le moment.',
		allFilesMatch: 'Tous les fichiers correspondent déjà.',
		previewSummary:
			'{missing} manquants, {unchanged} inchangés, {conflicts} conflits ignorés.',
		conflictSkipNote:
			'Les fichiers en conflit ne sont pas écrasés. Workduck les laisse inchangés.',
		...
		apply: 'Appliquer',
		applyWithoutConflicts: 'Appliquer sans conflits',
		appliedSummary: 'ssealed appliqué. {added} fichiers ajoutés.',
		appliedWithSkippedConflictsSummary:
			'ssealed appliqué. {added} fichiers ajoutés et {conflicts} conflits ignorés.',
		optionText: '{label} - {description}',
		fallbackScopeDescription: 'Utiliser le scaffold ssealed {label}.',
		fallbackProfileDescription: 'Adapter le scaffold pour un dépôt {label}.',
		fileStatuses: {
			missing: 'Ajouter',
			added: 'Ajouté',
			unchanged: 'Conserver',
		...
		optionLabels: {
			...
			'infra-module': 'Module infra',
			'data-pipeline': 'Pipeline de données',
			'github-action': 'GitHub Action',
			'browser-extension': 'Extension navigateur',
			plugin: 'Plugin',
			'docs-site': 'Site de docs',
			monorepo: 'Monorepo'
		},
		scopeDescriptions: {
			backend: 'Docs d\'API serveur, bases de données, jobs et propriété backend.',
			frontend: 'Docs d\'UI navigateur, routes, composants et comportement client.',
			fullstack: 'Limites frontend et backend pour un dépôt applicatif.',
			general: 'Docs produit et architecture quand la stack n\'est pas encore décidée.',
			mobile: 'Docs de propriété, release, appareil et runtime pour app mobile.',
			infra: 'Docs d\'infrastructure, déploiement, opérations et runbooks.',
			data: 'Docs de pipeline de données, lignage, qualité et contrats analytiques.'
		},
		profileDescriptions: {
			generic: 'Paramètres neutres pour un dépôt ordinaire.',
			'cli-tool': 'Outils en ligne de commande avec docs de commandes, options et releases.',
			'api-service': 'Services HTTP ou RPC avec contrats API et docs opérationnelles.',
			'desktop-app': 'Apps desktop avec docs de packaging, mise à jour et runtime.',
			library: 'Packages réutilisables avec API publique et docs de compatibilité.',
			'web-app': 'Applications web avec docs de routage, rendu et déploiement.',
			'mobile-app': 'Apps mobiles avec docs de plateforme, store et appareil.',
			sdk: 'SDK développeur avec API client et versioning.',
			'worker-service': 'Workers, files, planificateurs et docs de retry.',
			'infra-module': 'Modules infra avec docs de plan, apply et rollback.',
			'data-pipeline': 'Ingestion, transformation, lignage et qualité des données.',
			'github-action': 'GitHub Actions avec inputs, permissions et docs de release.',
			'browser-extension': 'Extensions navigateur avec permissions et release store.',
			plugin: 'Intégrations de type plugin avec contrats d\'hôte et cycle de vie.',
			'docs-site': 'Sites de documentation avec navigation et publication.',
			monorepo: 'Dépôts multipackages avec workspace et propriété.'
		}
	},
	errors: {
