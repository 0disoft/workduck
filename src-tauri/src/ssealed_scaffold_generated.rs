...
pub const SSEALED_SCAFFOLD_TOOL_VERSION: &str = "0.2.0";
pub const SSEALED_SCAFFOLD_SCOPE: &str = "fullstack";
pub const SSEALED_SCAFFOLD_RUNNER: &str = "none";
